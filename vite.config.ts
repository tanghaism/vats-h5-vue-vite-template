...
const jsLink = [
  ...
  `https://cdnjs.cloudflare.com/ajax/libs/vant/${getVersion('vant')}/vant.min.js`,
];

const cssLink = [`https://cdnjs.cloudflare.com/ajax/libs/vant/${getVersion('vant')}/index.min.css`];
